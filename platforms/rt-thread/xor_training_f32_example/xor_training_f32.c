...
int aifes_xor_training_f32(int argc, char* argv[])
{
    printf("AIfES XOR training demo (ESP-IDF)\n");
    ...
    printf("Parameter memory: %" PRIu32 " bytes\n", param_size);
    ...
    printf("Training memory: %lu bytes\n", mem_size);
...
MSH_CMD_EXPORT(aifes_xor_training_f32, AIfES XOR training demo (F32));
