/*
 * AIfES XOR training demo for Zephyr RTOS
 */
...
int main(void)
{
    printf("\n");
    printf("=================================\n");
    printf("AIfES XOR training demo (Zephyr)\n");
    printf("=================================\n");

    /*
     * Zephyr usually does not provide time()
     * for entropy on embedded targets.
     *
    ...
    if (!param_mem)
    {
        printf("ERROR: parameter allocation failed\n");
        return -1;
    }
    ...
    if (!mem)
    {
        printf("ERROR: training allocation failed\n");
        free(param_mem);
